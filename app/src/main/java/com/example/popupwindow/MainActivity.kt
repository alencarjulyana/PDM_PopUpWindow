...
class MainActivity : AppCompatActivity() {
    ...
    inner class OnSwipe: ItemTouchHelper.SimpleCallback(
        ...
        override fun onMove(
            ...
            (this@MainActivity.rvNames.adapter as MyAdapter).del(viewHolder.adapterPosition,
                target.adapterPosition)
            return true
        }

        override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
            (this@MainActivity.rvNames.adapter as MyAdapter).mov(viewHolder.adapterPosition)
        }
    }
}